...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Material.creator_id'
        db.delete_column(u'vpw_material', 'creator_id_id')

        # Adding field 'Material.creator'
        db.add_column(u'vpw_material', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Material.creator_id'
        db.add_column(u'vpw_material', 'creator_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Material.creator'
        db.delete_column(u'vpw_material', 'creator_id')
