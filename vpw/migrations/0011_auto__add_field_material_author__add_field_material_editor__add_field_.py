...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'vpw_material', 'author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Material.editor'
        db.add_column(u'vpw_material', 'editor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Material.licensor'
        db.add_column(u'vpw_material', 'licensor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Material.maintainer'
        db.add_column(u'vpw_material', 'maintainer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Material.translator'
        db.add_column(u'vpw_material', 'translator',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Material.coeditor'
        db.add_column(u'vpw_material', 'coeditor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'vpw_material', 'author')

        # Deleting field 'Material.editor'
        db.delete_column(u'vpw_material', 'editor')

        # Deleting field 'Material.licensor'
        db.delete_column(u'vpw_material', 'licensor')

        # Deleting field 'Material.maintainer'
        db.delete_column(u'vpw_material', 'maintainer')

        # Deleting field 'Material.translator'
        db.delete_column(u'vpw_material', 'translator')

        # Deleting field 'Material.coeditor'
        db.delete_column(u'vpw_material', 'coeditor')
