...
urlpatterns = patterns('',
    ...
    url(r'^m/(?P<title>[0-9A-Za-z_\-]+)/(?P<mid>[0-9a-z]{8})(/(?P<version>\d+))?/?$', 'vpw.views.module_detail', name='module_detail'),
    url(r'^m/(?P<mid>[0-9a-z]+)(/(?P<version>\d+))?/?$', 'vpw.views.module_detail_old', name='module_detail_old'),
    url(r'^c/(?P<title>[0-9A-Za-z_\-]+)/(?P<cid>[0-9a-z]{8})(/(?P<mid>[0-9a-z]+))?/?$', 'vpw.views.collection_detail', name='collection_detail'),
