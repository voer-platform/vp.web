...
urlpatterns = patterns('',
    ...
    url(r'^m/(?P<mid>[0-9a-f]+)(/(?P<version>\d+))?/?$', 'vpw.views.module_detail_old', name='module_detail_old'),
    url(r'^m/(?P<title>[0-9A-Za-z_\-]+)/(?P<mid>[0-9a-f]+)(/(?P<version>\d+))?/?$', 'vpw.views.module_detail', name='module_detail'),
    url(r'^c/(?P<cid>[0-9a-f]+)(/(?P<mid>[0-9a-f]+))?/?$', 'vpw.views.collection_detail_old', name='collection_detail_old'),
