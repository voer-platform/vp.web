...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			//Huy.VQ
			t.iframeHTML += '<link type="text/css" rel="stylesheet" href="/static/css/display-mathml.css" />';
			...
			t.iframeHTML += '</head><body id="' + bi + '" class="mceContentBody ' + bc + '" onload="window.parent.tinyMCE.get(\'' + t.id + '\').onLoad.dispatch();"><br>';
			t.iframeHTML += '<script type="text/javascript" src="/static/js/display-mathml.js"></script>';
			t.iframeHTML += '</body></html>';
